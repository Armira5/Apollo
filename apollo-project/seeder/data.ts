export const workers = [
    {
      ...
      guestCapacity: 1,
      isShtimiUserit: true,
      isQasjaTekPuntoret: true,
      isGjenimiRaportit: false,  
      isWorkerCleaning: true,
      ratings: 0,
      numOfReviews: 0,
      images: [
        {
    ...
    },
    {
      ...
      guestCapacity: 2,
      isShtimiUserit: true,
      isQasjaTekPuntoret: false,
      isGjenimiRaportit: true,
      isWorkerCleaning: true,
      ratings: 0,
      numOfReviews: 0,
      images: [
    ...
    },
    {
      ...
      pricePerDay: 95,
      description:
        "Our largest worker with a queen bed and foldable sofa. Comfortably fits 2-3 adults, four adults maximum. Decorated with Irish-themed colors and arts. It has a private bathworker with a shower, equipped with smart TV, mini-fridge, desk, chairs. Enjoy City views at the sitting area by the window. Located on the 3rd floor with no elevator.",
    ...
    {
      name: "Hotel Chimayo de Santa Fe Workers",
      pricePerDay: 36,
      description:
        "Our largest worker with a queen bed and foldable sofa. Comfortably fits 2-3 adults, four adults maximum. Decorated with Irish-themed colors and arts. It has a private bathworker with a shower, equipped with smart TV, mini-fridge, desk, chairs. Enjoy City views at the sitting area by the window. Located on the 3rd floor with no elevator.",
    ...
    {
      name: "Hotel Garni Ischgl 4 star worker comfort",
      pricePerDay: 82,
      description:
        "Our largest worker with a queen bed and foldable sofa. Comfortably fits 2-3 adults, four adults maximum. Decorated with Irish-themed colors and arts. It has a private bathworker with a shower, equipped with smart TV, mini-fridge, desk, chairs. Enjoy City views at the sitting area by the window. Located on the 3rd floor with no elevator.",
